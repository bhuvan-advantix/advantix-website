...
// Load .env manually and properly handle Windows \r
...
try {
  ...
  envFile.split('\n').forEach(line => {
    // Strip carriage return and spaces
...
console.log(`Config Loaded:\n  API_KEY: ${RESEND_API_KEY?.substring(0,8)}***\n  ADMIN: ${ADMIN_EMAIL}\n  FROM: ${FROM_EMAIL}`);
                    ...
                    <tr>
                        <td align="center" style="padding: 30px 40px; background-color: #050508; border-top: 1px solid #1e1e2d;">
                            <p style="margin: 0 0 12px 0; color: #6b7280; font-size: 13px; font-weight: 500;">
                                For urgent matters, directly contact <a href="mailto:${ADMIN_EMAIL}" style="color: #7c3aed; text-decoration: none;">${ADMIN_EMAIL}</a>
                            </p>
...
app.post('/api/contact', async (req, res) => {
  ...
  try {
    ...
    console.log('Action: Admin Notification Sent', adminRes);
    ...
    console.log('Action: Client Auto-Reply Sent', clientRes);
